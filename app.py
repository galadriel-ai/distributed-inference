...
async def lifespan(_: FastAPI):
    ...
    connected_node_ids = [node.uid for node in connected_node_repository.get_locally_connected_nodes()]
    await dependencies.get_node_repository().set_nodes_inactive(connected_node_ids)
    metrics_task.cancel()
