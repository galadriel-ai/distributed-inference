...
class Agent(Base):
    ...
    docker_image_hash = Column(String(), nullable=False)
...
class AgentInstance(Base):
    ...
    pcr0 = Column(String(), nullable=True)
...
class AgentAttestation(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid7)
    agent_instance_id = Column(UUID(as_uuid=True), ForeignKey(AgentInstance.id), nullable=False)
    attestation = Column(String(), nullable=False)
