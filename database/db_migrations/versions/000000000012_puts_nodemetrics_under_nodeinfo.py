...
def upgrade():
    ...
    op.drop_constraint(
        "node_metrics_user_profile_id_key", "node_metrics", type_="unique"
    )
    op.create_unique_constraint(None, "node_metrics", ["node_info_id"])
    op.drop_constraint(
        "node_metrics_user_profile_id_fkey", "node_metrics", type_="foreignkey"
    )
...
def downgrade():
    ...
    op.create_foreign_key(
        "node_metrics_user_profile_id_fkey",
        "node_metrics",
        "user_profile",
        ["user_profile_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        "node_metrics_user_profile_id_key", "node_metrics", ["user_profile_id"]
    )
    op.drop_column("node_metrics", "node_info_id")
    op.create_unique_constraint(
        "node_info_user_profile_id_key", "node_info", ["user_profile_id"]
    )
    # ### end Alembic commands ###
